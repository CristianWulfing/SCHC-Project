...
class SCHCFiniteStateMachine:
    ...
    class ErrorState(State):
        ...
        def receive_message(self, message):
            ...
            ------
            SystemError :
                Raises a SystemError with error code 1
            """
            raise SystemError(self.sm.__error_msg__)
    ...
    class EndState(State):
        ...
        def receive_message(self, message):
            ...
            ------
            SystemExit :
                Raises a SystemExit with error code 0
            """
    ...
    def get_bin_cw(self):
        return int(("{0:b}".format(int(self.__cw__)))[-1])

    def get_prev_bin_cw(self):
        return int(("{0:b}".format(int(self.__cw__ - 1)))[-1])